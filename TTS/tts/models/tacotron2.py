...
from mozilla.layers.gst_layers import GST
from mozilla.layers.tacotron2 import Decoder, Encoder, Postnet
from mozilla.models.tacotron_abstract import TacotronAbstract
...
class Tacotron2(TacotronAbstract):
    ...
    def forward(
        self, text, text_lengths, mel_specs=None, mel_lengths=None, speaker_ids=None
    ):
        self._init_states()
    ...
    def inference_truncated(self, text, speaker_ids=None):
        ...
        encoder_outputs = self._add_speaker_embedding(encoder_outputs, speaker_ids)
